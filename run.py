...
{P}[•]{B}--------------------------------------------------------------------{P}[•]
{B} |
{P}[•]{B}-----> {P}AUTHOR : {B}MR.XNXX X NANO {P}MR.REMBO
{P}[•]{B}-----> {P}GITHUB : {B}https://github.coM
{P}[•]{B}-----> {p}FACBOOK : {B}10003
{B} |""")
...
def menu():
    ...
    try:
        ...
        print(f"{B} | ")
        print(f"{B} | ")
        jalan(f"{P}[•]{M} Token modar wae ");os.system("rm -rf masuk.txt");logs()
    os.system("clear");banner()
    print(f"{B} | ")
    jalan(f"{P}[•] Nama akun      : {B}{lolol}") ####<<<<<<<< AHAHAHAHA
...
def userset():
    ...
    if _pil_ in ["1","01"]:
        ...
        try:
            ...
            _tes_ua=("Mozilla/5.0 (Linux; Android 6.0.1; SM-J500G Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Mobile Safari/537.36[FB_IAB/FB4A;FBAV/181.0.0.36.82;]")
        print(f"{B} | ")
...
def log_hasil(user, pasw):
    ua = "Mozilla/5.0 (Linux; Android 6.0.1; SM-J500G Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Mobile Safari/537.36[FB_IAB/FB4A;FBAV/181.0.0.36.82;]"
